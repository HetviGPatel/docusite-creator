...
export const Route = createFileRoute("/products")({
  ...
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Over 3 Million products across Railways, Metro, Defence, Manufacturing, Energy and more. 7,500+ approved vendors." },
      { property: "og:title", content: "Products — Jigisha Industrial Supermarket" },
      { property: "og:description", content: "3M+ products across diverse industries. Single-source procurement partner." },
    ],
  }),
});

const categories = [
  { name: "Railway Components", count: "500K+", items: ["Rolling stock parts", "Signaling equipment", "OHE structures", "KAWACH systems", "Track machines", "Station infrastructure"] },
  { name: "Metro Rail Systems", count: "200K+", items: ["Doors & HVAC", "ATC systems", "Platform screen doors", "Escalators & lifts", "Ticketing systems"] },
  { name: "Defence & Aerospace", count: "150K+", items: ["Precision machined parts", "Electronic sub-assemblies", "Strategic materials", "Military components"] },
  { name: "Electricals & Electronics", count: "400K+", items: ["Panels & switchgear", "Cables & wires", "LED lighting", "VFD & sensors", "Smart energy systems"] },
  { name: "Industrial Machinery", count: "300K+", items: ["CNC machines", "Fabrication tools", "Material handling", "Conveyor systems", "Automation equipment"] },
  { name: "Automobile Parts", count: "250K+", items: ["Spares & accessories", "EV components", "Lubricants", "Tyres & brakes", "Fleet supplies"] },
  { name: "Green Energy", count: "100K+", items: ["Solar panels & pumps", "Bio-CNG systems", "Energy monitoring", "Waste-to-energy", "Sustainability products"] },
  { name: "Agro & Pharma", count: "200K+", items: ["Seeds & fertilizers", "Agro machinery", "APIs & excipients", "Medical devices", "Lab equipment"] },
];
      ...
      <section className="py-20 bg-background">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="mt-12 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {categories.map(c => (
              <div key={c.name} className="bg-card rounded-xl p-5 border border-border shadow-card hover:shadow-card-hover hover:border-gold/30 transition-all">
